                  ...
                  child: Consumer<CartProvider>(
                    builder: (context, cartProvider, child) {
                      return Column(
                        ...
                        children: [
                          Text(
                              'Total Amount             : ${CurrencyHelper.formatCurrencyCompact(context.cartProvider.getCartSubTotal())}',
                              style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          Text(
                              'Total Offer Applied  : ${CurrencyHelper.formatCurrencyCompact(cartProvider.couponCodeDiscount)}',
                              style: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black)),
                          Text(
                              'Grand Total            : ${CurrencyHelper.formatCurrencyCompact(context.cartProvider.getGrandTotal())}',
                              style: const TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.blue)),
                ...
                Consumer<CartProvider>(
                  builder: (context, cartProvider, child) {
                    return CompleteOrderButton(
                        labelText:
                            'Complete Order  ${CurrencyHelper.formatCurrencyCompact(context.cartProvider.getGrandTotal())} ',
                        onPressed: () {
