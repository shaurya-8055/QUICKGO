...
class _AdvancedReviewsSectionState extends State<AdvancedReviewsSection> {
      ...
      child: Padding(
        ...
        child: Row(
          children: [
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        (_productRating!.averageRating ?? 0).toStringAsFixed(1),
                      ...
                      Padding(
                        ...
                        child: StarRating(
                          rating: _productRating!.averageRating ?? 0,
                          size: 20,
                        ),
                      ),
                    ],
            ...
            Expanded(
              flex: 3,
              child: _buildRatingDistribution(theme),
            ),
          ],
        ),
      ),
  ...
  Widget _buildRatingDistribution(ThemeData theme) {
    final distribution = _productRating?.ratingDistribution ?? {};
    final total = _productRating?.totalReviews ?? 1;
              ...
              children: [
                ...
                Expanded(
                  child: LinearProgressIndicator(
                    value: (distribution[rating] ?? 0) / total,
