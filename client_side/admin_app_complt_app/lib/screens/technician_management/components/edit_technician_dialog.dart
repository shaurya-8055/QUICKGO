...
class _EditTechnicianDialogState extends State<EditTechnicianDialog> {
  ...
  void initState() {
    ...
    _skills = List.from(widget.technician.skills ?? []);
    _isActive = widget.technician.active ?? true;
  }
  ...
  void _updateTechnician() async {
    ...
    try {
      ...
      final result = await provider.updateTechnician(
        id: widget.technician.sId!,
